(() => {
  ...
  window.addEventListener("load", function (e) {
    ne(),
      document.querySelector(".case__slider") &&
        new se(".case__slider", {
          modules: [ie],
          observer: !0,
          observeParents: !0,
      ...
      document.querySelector(".experts__slider") &&
        new se(".experts__slider", {
          modules: [ie],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
      ...
      document.querySelector(".solution__slider") &&
        new se(".solution__slider", {
          modules: [ie],
          observer: !0,
          observeParents: !0,
          slidesPerView: 4,
